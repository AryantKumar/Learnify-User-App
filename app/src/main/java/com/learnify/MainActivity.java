...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Transparent status bar with fullscreen layout (while keeping nav bar default)
        ...
        // Add all fragments and show only home
        ...
        setBackground(R.drawable.quiz_bg); // Set background for first tab
